        ...
        public async Task<IActionResult> Create(PaymentRecordCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var payrecord = new PaymentRecord()
                {
                    ...
                    SLC = studentLoan = _employeeService.StudentRepaymentAmount(model.EmployeeId, totalEarnings),
                    NIC = _nationalInsurance = _nationalInsuranceContributionService.NIContribution(totalEarnings),
                    TotalDeduction = totalDeduction = _payComputationService.TotalDeduction(tax, _nationalInsurance, studentLoan, unionFee),
